...
trait PgArrayJdbcTypes extends JdbcTypesComponent {
  ...
  class SimpleArrayListJdbcType[T](sqlBaseType: String)(
    ...
    def basedOn[U](tmap: T ⇒ U, tcomap: U ⇒ T): DriverJdbcType[List[T]] =
      new SimpleArrayListJdbcType[T](sqlBaseType) {
        ...
        override def getValue(r: ResultSet, idx: Int): List[T] = {
          val value = r.getArray(idx)
          if (r.wasNull) null
          else value.getArray.asInstanceOf[Array[Any]]
    ...
    /**
     * copy from [[org.postgresql.jdbc4.AbstractJdbc4Connection# c r e a t e A r r a y O f (..)]]
     * and [[org.postgresql.jdbc2.AbstractJdbc2Array# e s c a p e A r r a y E l e m e n t (..)]]
     */
